# Hilo - Sistema de Memoria del Proyecto

> **Hilo** es el componente de memoria dinamica del ecosistema **Ovillo**.
...
Hilo toma su nombre del concepto de **memoria duradera**: la informacion que persiste entre sesiones,
usuarios y sprints. Mientras que el codigo cambia con cada commit, Hilo mantiene el **contexto vivo**
...
Ovillo (ecosistema completo)
  |
  +-- Hilo (_hilo/)        --> Memoria dinamica del proyecto (este componente)
  |     Estado, sesiones, lecciones, historial
  |
  +-- Patrón (_patron/)        --> Base de conocimiento estatica
  |     Indice de Documentos_Base, rules, patterns
  |
  +-- Comandos (.claude/)    --> 35 comandos + 12 skills + 10 reglas
  +-- Documentos_Base/       --> Estandares y guias del ecosistema
```
...
| Comando | Lee de Hilo | Escribe en Hilo |
|---------|-------------|-----------------|
