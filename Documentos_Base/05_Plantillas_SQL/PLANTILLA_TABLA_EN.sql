...
(
    ...
    Code NVARCHAR(20) NOT NULL,               -- Unique business code
    Name NVARCHAR(100) NOT NULL,              -- Descriptive name
...
- IX_{TableName}_Code: For code searches
- IX_{TableName}_CreatedAt: For chronological ordering
*/
