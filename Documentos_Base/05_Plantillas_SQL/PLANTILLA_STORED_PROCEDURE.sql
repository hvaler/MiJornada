...
CREATE OR ALTER PROCEDURE [{Schema}].[usp_{Entity}_{Accion}]
    -- ==========================================
    ...
    @ErrorMessage NVARCHAR(500) = NULL OUTPUT   -- Message de error si falla
AS
BEGIN
    -- ==========================================
    ...
    BEGIN CATCH
        ...
        --     @Procedimiento = '{Schema}.usp_{Entity}_{Accion}',
...
-- =============================================
-- GRANT EXECUTE ON [{Schema}].[usp_{Entity}_{Accion}] TO [db_app_executor];
-- GO
...
EXEC [{Schema}].[usp_{Entity}_{Accion}]
    @Id = 1,
    @Parametro1 = 'Valor',
    @Parametro2 = 100,
