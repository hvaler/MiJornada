...
Estándares visuales y de experiencia de usuario para aplicaciones de la la organización.
...
| Logo | Uso | Ubicación |
|------|-----|-----------|
| **Logo (principal)** | Header de aplicaciones | `assets/logo.svg` |
| **OTD** | Footer o secundario | `assets/logo_otd.svg` |

**Reglas de uso:**
- Logo de la organización siempre visible en header
...
| Nombre | HEX | RGB | Uso |
|--------|-----|-----|-----|
| **Color primario** | `#33475B` | rgb(51, 71, 91) | Headers, botones primarios |
