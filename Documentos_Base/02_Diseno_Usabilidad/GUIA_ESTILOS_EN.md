...
Visual and user experience standards for OTD applications - la organización.
...
| Logo | Use | Location |
|------|-----|-----------|
| **Logo (primary)** | Application header | `assets/logo.svg` |
...
| Name | HEX | RGB | Use |
|--------|-----|-----|-----|
| **Primary** | `#33475B` | rgb(51, 71, 91) | Headers, primary buttons |
