...
Guía técnica para proyectos de la Oficina de Transformación Digital (OTD) de la la organización.
...
public class MiServicio
{
    ...
    public async Task<DatosDto> GetDatosAsync(string id)
    {
        ...
        var datos = await _repository.GetAsync(id);
...
public class MiServicio
{
    ...
    public async Task ProcessAsync(DatosDto datos)
    {
